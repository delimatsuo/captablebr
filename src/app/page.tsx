...
const stats = [
  ...
  { value: "IA", label: "Extracao automatica" },
];
...
const steps = [
  {
    ...
    description:
      "Preencha o perfil da sua startup: estagio, setor, modelo de negocio. Leva menos de 2 minutos.",
    icon: (
  ...
  {
    number: "02",
    title: "Compartilhe grants de equity",
    description:
      "Adicione manualmente ou faca upload de contratos. Nossa IA extrai os dados automaticamente.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Visualize percentis p25/p50/p75 de equity por cargo, segmentado por estagio, setor e modelo.",
    icon: (
...
const trustItems = [
  { title: "Anonimizacao total", desc: "Nenhuma empresa e identificada." },
  { title: "Minimo de N empresas", desc: "Benchmarks so com dados suficientes." },
  { title: "Documentos efemeros", desc: "Deletados apos extracao por IA." },
  { title: "LGPD compliant", desc: "Conformidade com a LGPD." },
];
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-28 sm:pb-32">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
              ...
              Plataforma para founders brasileiros
            </div>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tighter leading-[1.05] mb-6">
              Quanto equity oferecer para seu{" "}
              <span className="text-primary">proximo executivo?</span>
            </h1>
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              Benchmarks anonimizados de compensacao em equity para startups
              brasileiras. Dados reais de founders, agregados com seguranca.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold tracking-tight">
              Tres passos para benchmarks de equity
            </h2>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center rounded-3xl bg-zinc-900 p-12 sm:p-16 shadow-2xl">
            <h2 className="text-3xl font-semibold tracking-tight text-white mb-4">
              Pronto para tomar decisoes baseadas em dados?
            </h2>
            <p className="text-zinc-400 text-lg mb-8">
              Junte-se a founders que ja usam CaptableBR para definir
              compensacao de equity competitiva.
            </p>
            <Link href="/request-access">
              <Button
                size="lg"
